...
const errorFormats = ['pretty', 'colorless', 'minimal'];
...
export function validatePrismaClientOptions(options, datasourceNames) {
    for (const [key, value] of Object.entries(options)) {
...
//# sourceMappingURL=validatePrismaClientOptions.js.map