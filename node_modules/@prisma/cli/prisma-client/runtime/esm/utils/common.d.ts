...
export declare function needsNamespace(field: BaseField, dmmf: DMMFClass): boolean;
...
export declare function stringifyGraphQLType(type: string | DMMF.InputType | DMMF.SchemaEnum): string;
export declare function wrapWithList(str: string, isList: boolean): string;
export declare function getGraphQLType(value: any, potentialType?: string | DMMF.SchemaEnum | DMMF.InputType): string;
...
export declare function stringifyInputType(input: string | DMMF.InputType | DMMF.SchemaEnum, greenKeys?: boolean): string;
export declare function argIsInputType(arg: DMMF.ArgType): arg is DMMF.InputType;
export declare function getInputTypeName(input: string | DMMF.InputType | DMMF.SchemaField | DMMF.SchemaEnum): string;
export declare function getOutputTypeName(input: string | DMMF.OutputType | DMMF.SchemaField | DMMF.SchemaEnum): string;
export declare function inputTypeToJson(input: string | DMMF.InputType | DMMF.SchemaEnum, isRequired: boolean, nameOnly?: boolean): string | object;
...
export declare function isGroupByOutputName(type: string): boolean;
export declare function isSchemaEnum(type: any): type is DMMF.SchemaEnum;
