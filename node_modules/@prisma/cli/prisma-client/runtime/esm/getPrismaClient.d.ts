...
export declare type Action = 'findOne' | 'findUnique' | 'findFirst' | 'findMany' | 'create' | 'update' | 'updateMany' | 'upsert' | 'delete' | 'deleteMany' | 'executeRaw' | 'queryRaw' | 'aggregate';
...
export declare class PrismaClientFetcher {
    ...
    request({ document, dataPath, rootField, typeName, isList, callsite, clientMethod, runInTransaction, showColors, engineHook, args, headers, transactionId, }: {
        document: Document;
        dataPath: string[];
        rootField: string;
        typeName: string;
...
export declare function getOperation(action: DMMF.ModelAction | 'findOne'): 'query' | 'mutation';
