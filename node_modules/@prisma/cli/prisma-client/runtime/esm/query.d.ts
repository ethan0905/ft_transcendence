...
export declare class Document {
    ...
    protected printFieldError: ({ error }: FieldError, missingItems: MissingItem[], minimal: boolean) => string;
...
export declare class PrismaClientConstructorValidationError extends Error {
...
export declare function mapScalars({ field, data }: MapScalarsOptions): any;
